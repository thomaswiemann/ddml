...
#>  learner_1 0.2412 0.0299 0.9668
#>  learner_2 0.2412 0.0299 0.0000
#>  learner_3 0.2412 0.0299 0.0332
#> 
#>   y_X_Z1:
#>    learner   mspe     r2 weight
#>  learner_1 0.2424 0.0297 0.0000
#>  learner_2 0.2424 0.0297 0.8028
#>  learner_3 0.2424 0.0297 0.1972
#> 
#>   D_X_Z0:
#>    learner   mspe     r2 weight
#>  learner_1 0.2091 0.0791 0.9303
#>  learner_2 0.2091 0.0791 0.0000
#>  learner_3 0.2091 0.0791 0.0697
#> 
#>   D_X_Z1:
#>    learner   mspe     r2 weight
#>  learner_1 0.2234 0.0817 0.9557
#>  learner_2 0.2234 0.0817 0.0000
#>  learner_3 0.2234 0.0817 0.0443
#> 
#>   Z_X:
#>    learner   mspe     r2 weight
#>  learner_1 0.2499 -1e-04 0.0000
#>  learner_2 0.2499 -1e-04 0.5509
#>  learner_3 0.2499 -1e-04 0.4491
```
...
#> Ensemble type: nnls 
#>      Estimate Std. Error t value Pr(>|t|)
#> LATE   -0.231      0.187   -1.24     0.22
#> 
#> Ensemble type: singlebest 
#>      Estimate Std. Error t value Pr(>|t|)
#> LATE   -0.229      0.187   -1.22     0.22
#> 
#> Ensemble type: ols 
#>      Estimate Std. Error t value Pr(>|t|)
#> LATE   -0.231      0.187   -1.23     0.22
#> 
#> Ensemble type: average 
#>      Estimate Std. Error t value Pr(>|t|)
#> LATE   -0.229      0.189   -1.21     0.23
```
...
plm_rep <- ddml_replicate(ddml_plm,
                           ...
                           resamples = 5,
                           silent = TRUE)
#> Error in ddml_replicate(ddml_plm, y = y, D = D, X = X, learners = learners_multiple, : could not find function "ddml_replicate"
summary(plm_rep)
#> Error in eval(expr, envir, enclos): object 'plm_rep' not found
```
