...
#> 
#>     Estimate Std. Error t value Pr(>|t|)    
#> D_r -0.14723    0.00901   -16.3   <2e-16 ***
#> ---
...
#> DDML estimation: Flexible Partially Linear IV Model 
#> Obs: 2217   Folds: 10  Stacking: short-stack
#> 
#>     Estimate Std. Error t value Pr(>|t|)    
#> D_r -0.08145    0.00764   -10.7   <2e-16 ***
#> ---
#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
#> [5,] 0.4305 0.4593 0.3068
#> [6,] 0.5693 0.5407 0.6932
```
...
#>         y_X   D1_X  D1_XZ
#> [1,] 0.3116 0.1618 0.0621
#> [2,] 0.6884 0.8382 0.9379
```
