...
#> 
#>     Estimate Std. Error t value Pr(>|t|)    
#> D_r -0.14501    0.00885   -16.4   <2e-16 ***
#> ---
...
#> 
#>     Estimate Std. Error t value Pr(>|t|)    
#> D_r -0.10240    0.00867   -11.8   <2e-16 ***
#> ---
#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
#> [4,] 0.0000 0.0138 0.0000
#> [5,] 0.3786 0.5434 0.4844
#> [6,] 0.6214 0.4429 0.5156
```
...
#>         y_X   D1_X  D1_XZ
#> [1,] 0.2647 0.1262 0.0555
#> [2,] 0.7353 0.8738 0.9445
```
