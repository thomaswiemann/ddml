...
#> [5,] 0.4394 0.4501 0.3804
#> [6,] 0.5606 0.5499 0.6196
```
...
#> Error in rlassoIV(x = XL, d = D, y = y, z = ZL, select.Z = TRUE, select.X = FALSE, : could not find function "rlassoIV"
summary(rlassoIV_fit)
#> Error in eval(expr, envir, enclos): object 'rlassoIV_fit' not found
```
...
#> Error in eval(expr, envir, enclos): object 'stacking_r_fit' not found
```
