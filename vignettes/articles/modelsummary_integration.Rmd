...
names(ensemble_list)
#>  [1] "coefficients"     "ensemble_weights" "mspe"             "r2"              
#>  [5] "inf_func"         "dinf_dtheta"      "scores"           "J"               
#>  [9] "coef_names"       "estimator_name"   "ensemble_type"    "nobs"            
#> [13] "nfit"             "fit_labels"       "sample_folds"     "cv_folds"        
#> [17] "shortstack"       "cluster_variable" "fitted"           "splits"          
#> [21] "call"             "learners"         "learners_DX"
...
tidy(repl_fit)
#>          term   estimate  std.error statistic      p.value ensemble_type
#> 1          D1 -0.1865294 0.03218377 -5.795760 6.801254e-09          nnls
#> 2 (Intercept)  0.0035929 0.01525744  0.235485 8.138323e-01          nnls
#>   aggregation
#> 1      median
#> 2      median
