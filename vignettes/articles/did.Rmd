---
title: "Diff-in-Diff Estimation and Aggregation"
description: "Tutorial on DiD estimation with ddml_attgt, lincom aggregation, and uniform inference."
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Diff-in-Diff Estimation and Aggregation}
...
``ddml_attgt`` takes data in wide format: an $n \times T$ outcome matrix, a time-invariant covariate matrix, and a group vector:
...
The ``lincom_weights_did`` function constructs the contrast matrix $R$ and the influence function for the estimated weights. The output is passed directly to ``lincom`` for inference. For the dynamic type, both pre-treatment (placebo) and post-treatment event times are included:
...
#> e=0  -0.02010    0.01172   -1.71   0.0865 .  
...
<img src="figures/did-unnamed-chunk-7-1.png" alt="Dynamic Treatment Effect Estimates (OLS)." width="90%" />
<p class="caption">Dynamic Treatment Effect Estimates (OLS).</p>
</div>
...
#> 
#>      Estimate Std. Error z value Pr(>|z|)    
#> e=-4  0.00588    0.02457    0.24   0.8110    
#> e=-3  0.02752    0.01779    1.55   0.1218    
#> e=-2  0.02371    0.01457    1.63   0.1036    
#> e=0  -0.02131    0.01180   -1.81   0.0708 .  
#> e=1  -0.05714    0.01613   -3.54   0.0004 ***
#> e=2  -0.14076    0.03499   -4.02  5.7e-05 ***
#> e=3  -0.10395    0.03332   -3.12   0.0018 ** 
#> ---
#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
<div class="figure" style="text-align: center">
<img src="figures/did-unnamed-chunk-10-1.png" alt="Dynamic Treatment Effect Estimates (Stacking)." width="90%" />
<p class="caption">Dynamic Treatment Effect Estimates (Stacking).</p>
</div>
...
#> e=-3  0.02957    0.01761    1.68  0.09317 .  
#> e=-2  0.02405    0.01448    1.66  0.09662 .  
#> e=0  -0.01985    0.01167   -1.70  0.08898 .  
#> e=1  -0.05498    0.01642   -3.35  0.00081 ***
...
<div class="figure" style="text-align: center">
<img src="figures/did-unnamed-chunk-15-1.png" alt="Dynamic ATT with Uniform Confidence Bands." width="90%" />
<p class="caption">Dynamic ATT with Uniform Confidence Bands.</p>
</div>
