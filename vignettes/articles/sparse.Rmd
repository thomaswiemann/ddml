...
#> D_r   0.1121     0.0215    5.23  1.7e-07 ***
#> ---
...
```r
round(stacking_fit$ensemble_weights$D1_XZ, 4)
#> Error in round(stacking_fit$ensemble_weights$D1_XZ, 4): non-numeric argument to mathematical function
```
