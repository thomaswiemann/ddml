...
The resulting coefficient is close to the coefficient based on 180 instruments. The stacking diagnostics confirm that the first stage estimators with 180 instruments contribute almost exclusively to the final estimate, suggesting that the expansion to 1530 instruments has little benefit for the ols or lasso-based first stage fits.
