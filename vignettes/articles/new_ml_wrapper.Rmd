...
callbacks_list <- list(callback_early_stopping(monitor = "val_loss",
                       ...
                       callback_reduce_lr_on_plateau(monitor = "val_loss",
                                                     ...
                                                     patience = 10,
                                                     verbose = FALSE))
#> Error in FUN(X[[i]], ...): 'CreateProcess' failed to run 'C:\Program Files\WindowsApps\PythonSoftwareFoundation.Python.3.11_3.11.2544.0_x64__qbz5n2kfra8p0\python.exe -c "import sys; print(sys.platform)"'
...
late_fit <- ddml_late(y, D, Z, X,
                      ...
                      sample_folds = 10,
                      silent = TRUE)
#> Error in eval(expr, envir, enclos): object 'learner_keras' not found
summary(late_fit)
#> DDML estimation: Local Average Treatment Effect 
#> Obs: 5000   Folds: 10
#> 
