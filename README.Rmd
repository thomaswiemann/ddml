...
- ``vignette("neyman_orthogonality")`` introduces Neyman orthogonality in simple linear regression
...
- ``vignette("did")`` covers DiD estimation, aggregation, and inference in staggered adoption designs
